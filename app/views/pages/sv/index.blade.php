                ...
                <div class="small-8 columns small-centered">
                    ...
                    {{ Form::open(array("action" => "ToolsController@search", "method" => "get", "class" => "row search")) }}
                        <div class="small-12 columns">
                            <input type="text" name="query" placeholder="Hitta verktyg, tjänster, metoder och mer..." />
                        </div>
                        <!-- /small-12.columns -->
                    {{ Form::close() }}
                    <!-- /row.search -->
        ...
        <div class="small-10 columns small-centered">
            ...
            <div class="row">
                <div class="small-7 columns">
                    ...
                    <p><a href="#" class="more" title="Läs mer">Läs mer om Ruby on Rails</a></p>
                </div>
                <!-- /small-7.columns -->
                ...
                <div class="small-5 columns">
                    <article class="tool align row collapse" itemscope itemtype="http://schema.org/SoftwareApplication">
                        ...
                        <div class="small-6 columns">
                            ...
                            <p>uppdaterat för 2 dagar sedan</p>
                        </div>
                        <!-- /small-9.columns -->
                    </article>
