...
@section("breadcrumb", BreadcrumbHelper::renderAdmin(array(
    Lang::get("views.shared.navigation.admin.tools.name")
)))

@section("master-head")
    <div class="row">
        <div class="small-12 columns">
            <h1>{{ Lang::get("views.admin.tools.index.heading") }} <a href="{{ URL::route("admin.tools.create") }}" class="button right" title="{{ Lang::get("views.shared.navigation.admin.tools.create.title") }}" role="button"><span class="glyphicons circle_plus"></span> {{ Lang::get("views.shared.navigation.admin.tools.create.name") }}</a></h1>
