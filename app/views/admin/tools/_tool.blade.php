<tr>
    ...
    <td>
        ...
        <a href="{{ URL::route("admin.tools.delete", array("id" => $tool->id)) }}" title="{{ Lang::get("views/admin/tools/index.actions.delete.title") }}"><span class="glyphicon glyphicon-remove"></span></a>
    </td>
</tr>
