<div class="panel">
    {{ FormHelper::open($model, $options) }}
        ...
        {{ Form::submit(Lang::get("views.admin.data_types.{$action}.form.submit"), array("class" => "button")) }} &ndash; {{ Lang::get("views.shared.form.or") }} {{ link_to_route("admin.data-types.index", Lang::get("views.shared.form.cancel"), null, array("title" => Lang::get("views.shared.navigation.admin.data_types.title"))) }}
    {{ Form::close() }}
</div>
<!-- /panel -->
