...
@section("breadcrumb", BreadcrumbHelper::renderAdmin(array(
    Lang::get("views.shared.navigation.admin.data_types.name")
)))

@section("master-head")
    <div class="row">
        <div class="small-12 columns">
            <h1>{{ Lang::get("views.admin.data_types.index.heading") }} <a href="{{ URL::route("admin.data-types.create") }}" class="button right" title="{{ Lang::get("views.shared.navigation.admin.data_types.create.title") }}" role="button"><span class="glyphicons circle_plus"></span> {{ Lang::get("views.shared.navigation.admin.data_types.create.name") }}</a></h1>
