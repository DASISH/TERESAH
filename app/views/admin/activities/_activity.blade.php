<div class="row">
    ...
    <div class="small-10 columns">
        <p>{{ !$activity->existsIn($deletedActivities) ? link_to_route("admin.users.show", e($activity->user->name), array("id" => $activity->user_id), array("title" => e($activity->user->name))) : e($activity->name) }} @include("admin.activities.".strtolower($activity->target_type)."._".$activity->actionName(), compact("activity"))
