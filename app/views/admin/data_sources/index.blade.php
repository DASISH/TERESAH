...
@section("master-head")
    <div class="row">
        <div class="small-12 columns">
            <h1>{{ Lang::get("views/admin/data_sources/index.heading") }} <a href="{{ URL::route("admin.data-sources.create") }}" class="button right" title="{{ Lang::get("views/pages/navigation.admin.data_sources.create.title") }}" role="button"><span class="glyphicons circle_plus"></span> {{ Lang::get("views/pages/navigation.admin.data_sources.create.name") }}</a></h1>
