<div class="panel">
    {{ FormHelper::open($model, $options) }}
        ...
        {{ Form::submit(Lang::get("views.admin.data_sources.{$action}.form.submit"), array("class" => "button")) }} &ndash; {{ Lang::get("views.shared.form.or") }} {{ link_to_route("admin.data-sources.index", Lang::get("views.shared.form.cancel"), null, array("title" => Lang::get("views.shared.navigation.admin.data_sources.title"))) }}
    {{ Form::close() }}
</div>
<!-- /panel -->
