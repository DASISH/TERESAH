...
{ 
    public function run()
    {
        ...
        $data = array(
            ...
            array("tool" => "arcgis", "type" => "platform", "value" => "Windows"),
            ...
            array("tool" => "qgis", "type" => "keyword", "value" => "GIS"),
            array("tool" => "qgis", "type" => "keyword", "value" => "Map"),
            array("tool" => "qgis", "type" => "platform", "value" => "Windows"),
            array("tool" => "qgis", "type" => "platform", "value" => "Linux"),
            array("tool" => "qgis", "type" => "platform", "value" => "Mac"),
            array("tool" => "qgis", "type" => "homepage", "value" => "http://www.qgis.org"),            
            ...
            array("tool" => "adobe-photoshop", "type" => "keyword", "value" => "Content creation"),
            ...
            array("tool" => "autodesk-3ds-max", "type" => "keyword", "value" => "Content creation"),
