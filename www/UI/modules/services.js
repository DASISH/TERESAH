		...
		resolver : {
			...
			tools : {
				...
				one : function(item, options, callback) {
					...
					if(typeof(options)==='undefined') options =  {keyword:true, platform:true, developer : true, type:true, applicationType: true, licence : true, publications: true,projects: true,suite:true, standards:true, features:true};
					if(typeof(callback)==='undefined') callback = false;
